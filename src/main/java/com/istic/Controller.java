...
public class Controller implements Initializable {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		frequencyFineSlider.valueProperty().addListener(
				(ov, old_val, new_val) -> {
	...
	public void squareSound() {
		vco.changeShapeWave(SQUAREWAVE, lineOut);

	}

	public void sawSound() {
		vco.changeShapeWave(SAWTOOTHWAV, lineOut);

	}

	public void triangleSound() {
		vco.changeShapeWave(TRIANGLEWAVE, lineOut);
